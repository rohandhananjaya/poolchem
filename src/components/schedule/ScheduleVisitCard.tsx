...
/**
 * A single visit on the schedule: pool name + health badge, address, its
 * planned time, and either a "Start Visit" action (DRAFT) or a completed marker.
 */
export function ScheduleVisitCard({ visit, timeLabel }: ScheduleVisitCardProps) {
