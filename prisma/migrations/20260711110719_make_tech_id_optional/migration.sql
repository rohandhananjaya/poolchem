...
INSERT INTO "new_service_visits" ("createdAt", "id", "notes", "poolId", "scheduledAt", "status", "techId", "updatedAt", "weatherNotes") SELECT "createdAt", "id", "notes", "poolId", "scheduledAt", "status", "techId", "updatedAt", "weatherNotes" FROM "service_visits";
