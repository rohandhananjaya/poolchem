...
description: PoolChem's test setup, patterns, and conventions. Read BEFORE writing tests. Covers vitest config, mocking, and the patterns used across DB, action, component, and pure-function tests. Triggers on: editing or creating any *.test.ts or *.test.tsx file in src/.
---
